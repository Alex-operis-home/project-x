...
export default function RaymondPromoteurPage() {
  ...
  function send(e: React.FormEvent) {
    ...
    setMessages((m) => [
      ...
      { from: "raymond", text: "(démo) Ici Raymond appellerait l'API Claude/Anthropic pour répondre avec les données réelles du portefeuille." },
    ]);
    setValue("");
  }
